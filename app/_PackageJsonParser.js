...
class PackageJsonParser {
    ...
    configure (config) {
        if (config) {
            this.package.name = config.name() || 'hellocordova';
            this.package.displayName = ('Scris ' + config.name()) || 'HelloCordova';
            ...
            this.package.appId = "com.scrisstudio.switchable";
            this.package.dependencies = {
                //"alert-node": "^1.2.5", 
            }
            /*this.package.build = {
                appId: "com.scrisstudio.switchable",
                productName: "Switchable",
                mac: {
